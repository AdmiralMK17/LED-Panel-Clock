...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Настройка NTP</strong>
<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">NTP сервер:</td><td><input type="text" id="ntpserver" name="ntpserver" maxlength="172" value=""></td></tr>
<tr><td align="right">Обновлять каждые:</td><td><input type="text" id="update" name="update" size="3"maxlength="6" value=""> минут (0=не обновлять)</td></tr>
<tr><td>Часовая зона</td><td>
...
<tr><td align="right">Включить переход на летнее время:</td><td><input type="checkbox" id="dst" name="dst"></td></tr>
