...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Настройка сети</strong><hr>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
Подождите, пожалуйста .... Применение конфигурации и перезапуск.
)=====";
...
void send_connection_state_values_html()
{
	...
	if (WiFi.status() == 0) state = "Idle";
	 ...
	 if (n == 0)
	 {
		 Networks = "<font color='#FF0000'>Ни одной сети не найдено</font>";
	 }
	else
    {
		...
		Networks += "<tr bgcolor='#DDDDDD' ><td><strong>Название</strong></td><td><strong>Качество</strong></td><td><strong>Защита</strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
